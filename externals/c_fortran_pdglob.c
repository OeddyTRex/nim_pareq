 ...
 * for calling the SuperLU_DIST routine pdgssvx_ABglobal.
 */
...
int_t
c_fortran_pdglob_(int *iopt, int_t *n, int_t *nnz, int *nrhs, double *values,
 ...
 */
	...
	*factors = (long) LUfactors;
	...
	fprintf(stderr, "Invalid iopt=%d passed to c_fortran_pdglob()\n",*iopt);
	exit(-1);
    }
