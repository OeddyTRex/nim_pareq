c-----------------------------------------------------------------------
c     file local_ibm.f
c     module containing defintions of real and integer kinds for ibm
c     computers.
c-----------------------------------------------------------------------
      MODULE local
      USE io
...
c-----------------------------------------------------------------------
c     IBM system-dependent timer - returns elapsed CPU seconds
...
c-----------------------------------------------------------------------
c     binary open--c90 needs to call assign, ibm doesn't.
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
c     binary close--c90 needs to call assign, ibm doesn't.
c-----------------------------------------------------------------------
