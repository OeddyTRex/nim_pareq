c-----------------------------------------------------------------------
c     file local_sun.f
c     module containing defintions of real and integer kinds for sun
c     computers.
c-----------------------------------------------------------------------
      MODULE local
      USE io
...
c-----------------------------------------------------------------------
c SUN system-dependent timer - returns elapsed CPU seconds
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
c     binary open--c90 needs to call assign, sun doesn't.
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
c     binary close--c90 needs to call assign, sun doesn't.
c-----------------------------------------------------------------------
