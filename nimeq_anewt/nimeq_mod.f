...
c-----------------------------------------------------------------------
     ...
     $          allcoil_i
c-----------------------------------------------------------------------
c     the following arrays and scalars are used to find net plasma
c     current from information at quad points, and they need to be
c     defined here for use in Newton iteration.
c-----------------------------------------------------------------------
      REAL(r8), DIMENSION(:), ALLOCATABLE :: curarr,r2arr
      REAL(r8) :: dipdf,relerr,pli,iperr,bweight
      TYPE(vector_type), DIMENSION(:), ALLOCATABLE :: diperr
c-----------------------------------------------------------------------
c     close module.
c-----------------------------------------------------------------------
